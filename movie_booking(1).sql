...
--
-- Host: localhost:3306
-- Generation Time: Apr 12, 2026 at 02:30 PM
...
(3, 'Silent Spectacle', 'Experience the thriller of the year.', 'satyamevjayte.webp', 'inactive'),
...
(40, 43, 'BK-7EBF8903', 'Inception', '10:10 AM', '4', 200.00, 3, 'FREE ACCESS', 300.00, 'Cashfree', 'Pending', 'Pending', '2026-04-12 09:55:46');
...
(8, 'vekariya shreeya', 'vekariyashriya@gmail.com', 'dhg  dvfheeben b', '2026-04-02 16:41:06', 'read');
...
(16, 3, 'dxsfdf', 'dhjhf fdfhjgjghj', '2026-04-09 15:37:34', 'approved'),
(17, 3, 'abc', 'djfs;kjm;gvl', '2026-04-12 12:17:38', 'pending');
...
INSERT INTO `gallery` (`id`, `title`, `description`, `image_path`, `link`, `search_tags`, `created_at`, `status`) VALUES
(1, 'South Indian Movies', 'Blockbuster action dramas from South', 'south.jpg', 'south_movie.php', 'south tamil telugu kannada malayalam', '2026-04-07 12:59:36', 'inactive'),
(2, 'Horror Movies', 'Scary and thrilling horror films', 'Horrer.jpg', 'discover.php', 'horror scary ghost thriller', '2026-04-07 12:59:36', 'active'),
(3, 'Action Movies', 'High-octane action entertainers', 'war 11.jpg', 'action.php', 'action fight thriller', '2026-04-07 12:59:36', 'active'),
(4, 'Comedy Movies', 'Laugh riot comedy films', 'c.jpg', 'comedy.php', 'comedy funny hilarious', '2026-04-07 12:59:36', 'active'),
(5, 'Bollywood Hits', 'Top Bollywood blockbusters', 'hq720.jpg', 'bollywood.php', 'bollywood hindi shahrukh salman', '2026-04-07 12:59:36', 'active'),
(6, 'Hollywood Movies', 'International Hollywood hits', 'action.jpg', 'hollywood.php', 'hollywood english marvel dc', '2026-04-07 12:59:36', 'active'),
(7, 'Romantic Movies', 'Love and romance stories', 'r.jpg', 'romantic.php', 'romantic love heart', '2026-04-07 12:59:36', 'active'),
(8, 'Thriller Movies', 'Suspense thriller edge of seat', 'as3.jpg', 'thriller.php', 'thriller suspense mystery', '2026-04-07 12:59:36', 'active'),
(9, 'Animated Movies', 'Family friendly animations', 'as2.jpg', 'animated.php', 'animated cartoon kids', '2026-04-07 12:59:36', 'active'),
(10, 'Sci-Fi Movies', 'Science fiction futuristic', 's1.jpg', 'scifi.php', 'sci-fi science fiction future', '2026-04-07 12:59:36', 'active'),
(11, 'Documentary', 'Real stories and documentaries', 'as1.jpg', 'documentary.php', 'documentary real true story', '2026-04-07 12:59:36', 'active'),
(12, 'Classic Movies', 'Timeless classic cinema', 'as4.jpg', 'classic.php', 'classic old retro', '2026-04-07 12:59:36', 'active'),
(13, 'abc', 'abcdefghlijk', 'uploads/1775995106_night.jpg', 'abc', 'abcde', '2026-04-12 11:58:26', 'active');
...
INSERT INTO `movies` (`id`, `name`, `poster_img`, `is_new`, `status`) VALUES
(1, 'Deadpool 3', 'movie1.jpg', 1, 'active'),
(2, 'Kalki 2898 AD', 'movie2.jpg', 1, 'active'),
(3, 'Inside Out 2', 'movie3.jpg', 1, 'active'),
(4, 'The Fall Guy', 'movie4.jpg', 0, 'active'),
(5, 'Kingdom of the Planet of the Apes', 'movie5.jpg', 0, 'inactive');
...
(2, 'The Batman', 'batman.jpg', 400.00, 199.00, 'HOT DEAL', '2026-05-15', 'inactive'),
...
(4, 'Pushpa ', 'pushpa.jpg', 230.00, 150.00, 'Special Offer', '2026-12-31', 'inactive'),
(5, 'abc', 'drttydcfticdf', 300.00, 150.00, '50', '2026-04-26', 'active');
...
(5, 4, 'screen 2', 50, '3D', '\"vjkhjkb\"', '2026-04-12 11:33:57');
...
(5, 'rajkot cinema', 'dj hjhjdhffjhfjhfj hefjhejf', 'rajkot', 'gujarat', NULL, '7894561234', NULL, 1, 'Budget Friendly, Snacks Counter', 'inactive', '2026-03-30 16:44:17');
...
(44, '', 'Super Admin', 'admin@filmflix.com', '1234567890', '1990-01-01', 'admin123', '', 'surat', 'admin', 'active', '2026-04-12 10:47:27');
