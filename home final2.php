<?php
include 'gimini_dbconfig.php'; // Tamara database file nu naam
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div id="homeCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            $hero_res = mysqli_query($conn, $hero_sql);
            $count = 0;
                        ...
                        <div class="col-6 col-md-4 col-lg-custom text-center mb-4">
                            <div class="poster-container">
                                ...
                                <div class="poster-overlay">
                                    <button class="btn btn-sm btn-light w-100 rounded-pill fw-bold">Watch Now</button>
                                </div>
                            </div>
